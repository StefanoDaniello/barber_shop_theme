...
$text = esc_attr($attributes['textColor'] ?? '#ffffff');
                        ...
                        <?php if (! empty($slide['imageUrl'])) : ?>
                            <div class="w-full h-full">
                                ...
                                <?php if (! empty($slide['category']) || ! empty($slide['title'])) : ?>
                                    <div class="absolute bottom-5 right-5 p-4" style="background-color: <?php echo $overlay; ?>; z-index: 10;">
                                        <?php if (! empty($slide['category'])) : ?>
                                            <p class="text-sm" style="color: <?php echo $text; ?>;"><?php echo esc_html($slide['category']); ?></p>
                                        <?php endif; ?>
                                        <?php if (! empty($slide['title'])) : ?>
                                            <h3 class="text-lg font-bold" style="color: <?php echo $text; ?>;"><?php echo esc_html($slide['title']); ?></h3>
                                        <?php endif; ?>
                                    </div>
                                <?php endif; ?>
                            </div>
